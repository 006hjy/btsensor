...
sl_status_t sl_iostream_eusart_init_inst0(void)
{
  ...
  sl_iostream_dma_config_t rx_dma_config_inst0 = {.src = (uint8_t *)&SL_IOSTREAM_EUSART_INST0_PERIPHERAL->RXDATA,
                                                        .xfer_cfg = SL_HAL_LDMA_TRANSFER_CFG_PERIPHERAL(*(SL_IOSTREAM_EUSART_RX_DMA_SIGNAL(SL_IOSTREAM_EUSART_INST0_PERIPHERAL_NO)))};

  sl_iostream_dma_config_t tx_dma_config_inst0 = {.dst = (uint8_t *)&SL_IOSTREAM_EUSART_INST0_PERIPHERAL->TXDATA,
                                                        .xfer_cfg = SL_HAL_LDMA_TRANSFER_CFG_PERIPHERAL(*(SL_IOSTREAM_EUSART_TX_DMA_SIGNAL(SL_IOSTREAM_EUSART_INST0_PERIPHERAL_NO)))};
